...
export class BaseRepository<T extends BaseEntity> {
	 ...
	 */
	increment(id: string | number, column: string, amount?: number): void;
	increment(id: string | number, columns: Record<string, number>): void;
	increment(
		id: string | number,
	...
	decrement(id: string | number, column: string, amount?: number): void;
	decrement(id: string | number, columns: Record<string, number>): void;
	decrement(
		id: string | number,
		columnOrMap: string | Record<string, number>,
		amount = 1,
